...
print ('Use xi: {}'.format(args.use_xi))
...
net = Net(8, 16, [2048, 1024, 256])
print ('Net used:')
print (net)
net.to(device)
net_helper = Net(8, 16, [2048, 1024, 256])
...
for epoch in range(args.n_epochs):
    ...
    print ('Alpha normal:')
    for p in alpha_normal_dict.parameters():
        print (F.softmax(p))
    print ('Alpha reduce:')
    for p in alpha_reduce_dict.parameters():
        print (F.softmax(p))
